...
extension PointF: @unchecked Sendable {}
...
extension PointF: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: PointF, rhs: PointF) -> Bool {
